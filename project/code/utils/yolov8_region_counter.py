...
def run(
    ...
    while videocapture.isOpened():
        ...
        if view_img:
            ...
            cv2.resizeWindow('Ultralytics YOLOv8 Region Counter Movable', 800, 600)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r'D:\Downloads\test.mkv', help='video file path')
