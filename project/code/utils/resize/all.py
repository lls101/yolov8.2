...
# 输入和输出根目录
input_root_dir = r'D:\datasets\Wine-Grape-Dataset\摘叶后图片\Merlot'  # 替换为你的根目录
output_root_dir = r'D:\datasets\Wine-Grape-Dataset\摘叶后图片\Merlot\imresize'  # 替换为你的输出根目录

# 执行缩放和中心裁剪
resize_and_crop_center(input_root_dir, output_root_dir, target_size=(2048, 1365))hebing
