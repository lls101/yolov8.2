...
if __name__ == '__main__':
    ...
    #data = r'D:\datasets\test\1\augmented_data\out\data.yaml'
    #data = r'D:\datasets\test\1\augmented_data\out\data.yaml'
    #dultralytics\cfg\models\Add\yolov8-rtdetr.yaml'
    data = r'D:\datasets\wgsid\output\data.yaml'
    model = YOLO('yolov8s.yaml')  # Load model
    model.train(
        data=data,
        epochs=500,  # 训练200轮
        batch=12,  # 每批次12张图片
