...
def get_params():
    params = {
        'weight': r'runs\detect\train24\weights\best.pt',   # 训练出来的权重文件
...
if __name__ == '__main__':
    ...
    model(r'D:\Workspace\datasets\wgsid\images\CDY_2015.jpg', 'result')  # 第一个是检测的文件, 第二个是保存的路径